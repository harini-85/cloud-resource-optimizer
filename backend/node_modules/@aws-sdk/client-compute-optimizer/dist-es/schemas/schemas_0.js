...
export var AutoScalingGroupEstimatedMonthlySavings$ = [3, n0, _ASGEMS,
    0,
    [_cu, _v],
    [0, 1]
];
export var AutoScalingGroupRecommendation$ = [3, n0, _ASGR,
    0,
...
export var AutoScalingGroupRecommendationOption$ = [3, n0, _ASGRO,
    0,
...
export var AutoScalingGroupSavingsOpportunityAfterDiscounts$ = [3, n0, _ASGSOAD,
    0,
    [_sOP, _eMS],
    [1, () => AutoScalingGroupEstimatedMonthlySavings$]
];
export var ContainerConfiguration$ = [3, n0, _CC,
    0,
    [_cN, _mSC, _cp],
    [0, () => MemorySizeConfiguration$, 1]
];
export var ContainerRecommendation$ = [3, n0, _CR,
    0,
    [_cN, _mSC, _cp],
    [0, () => MemorySizeConfiguration$, 1]
];
export var CurrentPerformanceRiskRatings$ = [3, n0, _CPRR,
    0,
    [_h, _me, _l, _vL],
    [1, 1, 1, 1]
];
export var CustomizableMetricParameters$ = [3, n0, _CMP,
    0,
    [_th, _he],
    [0, 0]
];
export var DBStorageConfiguration$ = [3, n0, _DBSC,
    0,
    [_sT, _aSl, _i, _mAS, _sTt],
    [0, 1, 1, 1, 1]
];
export var DeleteRecommendationPreferencesRequest$ = [3, n0, _DRPR,
    0,
    [_rT, _rPN, _sc],
    [0, 64 | 0, () => Scope$], 2
];
export var DeleteRecommendationPreferencesResponse$ = [3, n0, _DRPRe,
    0,
    [],
    []
];
export var DescribeRecommendationExportJobsRequest$ = [3, n0, _DREJR,
    0,
    [_jI, _fi, _nT, _mR],
    [64 | 0, () => JobFilters, 0, 1]
];
export var DescribeRecommendationExportJobsResponse$ = [3, n0, _DREJRe,
    0,
    [_rEJ, _nT],
...
export var EBSFilter$ = [3, n0, _EBSF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
export var EBSSavingsEstimationMode$ = [3, n0, _EBSSEM,
    0,
    [_so],
    [0]
];
export var EBSSavingsOpportunityAfterDiscounts$ = [3, n0, _EBSSOAD,
    0,
    [_sOP, _eMS],
...
export var ECSSavingsEstimationMode$ = [3, n0, _ECSSEM,
    0,
    [_so],
    [0]
];
export var ECSSavingsOpportunityAfterDiscounts$ = [3, n0, _ECSSOAD,
    0,
    [_sOP, _eMS],
    [1, () => ECSEstimatedMonthlySavings$]
];
export var ECSServiceProjectedMetric$ = [3, n0, _ECSSPM,
    0,
    [_n, _ti, _uBV, _lBV],
    [0, 64 | 4, 64 | 1, 64 | 1]
];
...
export var ECSServiceRecommendationFilter$ = [3, n0, _ECSSRF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
export var ECSServiceRecommendationOption$ = [3, n0, _ECSSRO,
    0,
...
export var ECSServiceRecommendedOptionProjectedMetric$ = [3, n0, _ECSSROPM,
    0,
    [_rCU, _rMS, _pM],
...
export var EffectiveRecommendationPreferences$ = [3, n0, _ERP,
    0,
...
export var EnrollmentFilter$ = [3, n0, _EF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
...
export var ExportAutoScalingGroupRecommendationsRequest$ = [3, n0, _EASGRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA, _rP],
    [() => S3DestinationConfig$, 64 | 0, () => Filters, 64 | 0, 0, 2, () => RecommendationPreferences$], 1
];
export var ExportAutoScalingGroupRecommendationsResponse$ = [3, n0, _EASGRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportDestination$ = [3, n0, _ED,
    0,
    [_s_],
    [() => S3Destination$]
];
export var ExportEBSVolumeRecommendationsRequest$ = [3, n0, _EEBSVRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA],
    [() => S3DestinationConfig$, 64 | 0, () => EBSFilters, 64 | 0, 0, 2], 1
];
export var ExportEBSVolumeRecommendationsResponse$ = [3, n0, _EEBSVRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportEC2InstanceRecommendationsRequest$ = [3, n0, _EECIRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA, _rP],
    [() => S3DestinationConfig$, 64 | 0, () => Filters, 64 | 0, 0, 2, () => RecommendationPreferences$], 1
];
export var ExportEC2InstanceRecommendationsResponse$ = [3, n0, _EECIRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportECSServiceRecommendationsRequest$ = [3, n0, _EECSSRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA],
    [() => S3DestinationConfig$, 64 | 0, () => ECSServiceRecommendationFilters, 64 | 0, 0, 2], 1
];
export var ExportECSServiceRecommendationsResponse$ = [3, n0, _EECSSRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportIdleRecommendationsRequest$ = [3, n0, _EIRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA],
    [() => S3DestinationConfig$, 64 | 0, () => IdleRecommendationFilters, 64 | 0, 0, 2], 1
];
export var ExportIdleRecommendationsResponse$ = [3, n0, _EIRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportLambdaFunctionRecommendationsRequest$ = [3, n0, _ELFRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA],
    [() => S3DestinationConfig$, 64 | 0, () => LambdaFunctionRecommendationFilters, 64 | 0, 0, 2], 1
];
export var ExportLambdaFunctionRecommendationsResponse$ = [3, n0, _ELFRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportLicenseRecommendationsRequest$ = [3, n0, _ELRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA],
    [() => S3DestinationConfig$, 64 | 0, () => LicenseRecommendationFilters, 64 | 0, 0, 2], 1
];
export var ExportLicenseRecommendationsResponse$ = [3, n0, _ELRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExportRDSDatabaseRecommendationsRequest$ = [3, n0, _ERDSDRR,
    0,
    [_sDC, _aIc, _fi, _fTE, _fF, _iMA, _rP],
    [() => S3DestinationConfig$, 64 | 0, () => RDSDBRecommendationFilters, 64 | 0, 0, 2, () => RecommendationPreferences$], 1
];
export var ExportRDSDatabaseRecommendationsResponse$ = [3, n0, _ERDSDRRx,
    0,
    [_jIo, _sD],
    [0, () => S3Destination$]
];
export var ExternalMetricsPreference$ = [3, n0, _EMP,
    0,
    [_so],
    [0]
];
export var ExternalMetricStatus$ = [3, n0, _EMSx,
    0,
    [_sC, _sR],
    [0, 0]
];
...
export var GetAutoScalingGroupRecommendationsRequest$ = [3, n0, _GASGRR,
    0,
    [_aIc, _aSGAu, _nT, _mR, _fi, _rP],
    [64 | 0, 64 | 0, 0, 1, () => Filters, () => RecommendationPreferences$]
];
export var GetAutoScalingGroupRecommendationsResponse$ = [3, n0, _GASGRRe,
    0,
    [_nT, _aSGR, _er],
    [0, () => AutoScalingGroupRecommendations, () => GetRecommendationErrors]
];
export var GetEBSVolumeRecommendationsRequest$ = [3, n0, _GEBSVRR,
    0,
    [_vA, _nT, _mR, _fi, _aIc],
    [64 | 0, 0, 1, () => EBSFilters, 64 | 0]
];
export var GetEBSVolumeRecommendationsResponse$ = [3, n0, _GEBSVRRe,
    0,
    [_nT, _vR, _er],
    [0, () => VolumeRecommendations, () => GetRecommendationErrors]
];
export var GetEC2InstanceRecommendationsRequest$ = [3, n0, _GECIRR,
    0,
    [_iA, _nT, _mR, _fi, _aIc, _rP],
    [64 | 0, 0, 1, () => Filters, 64 | 0, () => RecommendationPreferences$]
];
export var GetEC2InstanceRecommendationsResponse$ = [3, n0, _GECIRRe,
    0,
    [_nT, _iR, _er],
...
export var GetECSServiceRecommendationsRequest$ = [3, n0, _GECSSRR,
    0,
    [_sAe, _nT, _mR, _fi, _aIc],
    [64 | 0, 0, 1, () => ECSServiceRecommendationFilters, 64 | 0]
];
export var GetECSServiceRecommendationsResponse$ = [3, n0, _GECSSRRe,
    0,
    [_nT, _eSR, _er],
    [0, () => ECSServiceRecommendations, () => GetRecommendationErrors]
];
export var GetEffectiveRecommendationPreferencesRequest$ = [3, n0, _GERPR,
    0,
    [_rA],
    [0], 1
];
export var GetEffectiveRecommendationPreferencesResponse$ = [3, n0, _GERPRe,
    0,
    [_eIM, _eMP, _lBP, _uP, _pRr],
    [0, () => ExternalMetricsPreference$, 0, () => UtilizationPreferences, () => EffectivePreferredResources]
];
export var GetEnrollmentStatusesForOrganizationRequest$ = [3, n0, _GESFOR,
    0,
    [_fi, _nT, _mR],
    [() => EnrollmentFilters, 0, 1]
];
export var GetEnrollmentStatusesForOrganizationResponse$ = [3, n0, _GESFORe,
    0,
    [_aES, _nT],
    [() => AccountEnrollmentStatuses, 0]
];
export var GetEnrollmentStatusRequest$ = [3, n0, _GESR,
    0,
    [],
    []
];
...
export var GetIdleRecommendationsResponse$ = [3, n0, _GIRRe,
    0,
    [_nT, _iRd, _er],
    [0, () => IdleRecommendations, () => IdleRecommendationErrors]
];
export var GetLambdaFunctionRecommendationsRequest$ = [3, n0, _GLFRR,
    0,
    [_fA, _aIc, _fi, _nT, _mR],
    [64 | 0, 64 | 0, () => LambdaFunctionRecommendationFilters, 0, 1]
];
export var GetLambdaFunctionRecommendationsResponse$ = [3, n0, _GLFRRe,
    0,
    [_nT, _lFR],
    [0, () => LambdaFunctionRecommendations]
];
export var GetLicenseRecommendationsRequest$ = [3, n0, _GLRR,
    0,
    [_rAe, _nT, _mR, _fi, _aIc],
    [64 | 0, 0, 1, () => LicenseRecommendationFilters, 64 | 0]
];
export var GetLicenseRecommendationsResponse$ = [3, n0, _GLRRe,
    0,
    [_nT, _lR, _er],
...
export var GetRDSDatabaseRecommendationsRequest$ = [3, n0, _GRDSDRR,
    0,
    [_rAe, _nT, _mR, _fi, _aIc, _rP],
    [64 | 0, 0, 1, () => RDSDBRecommendationFilters, 64 | 0, () => RecommendationPreferences$]
];
export var GetRDSDatabaseRecommendationsResponse$ = [3, n0, _GRDSDRRe,
    0,
    [_nT, _rDBR, _er],
    [0, () => RDSDBRecommendations, () => GetRecommendationErrors]
];
export var GetRecommendationError$ = [3, n0, _GRE,
    0,
    [_id, _cod, _m],
    [0, 0, 0]
];
export var GetRecommendationPreferencesRequest$ = [3, n0, _GRPR,
    0,
    [_rT, _sc, _nT, _mR],
    [0, () => Scope$, 0, 1], 1
];
export var GetRecommendationPreferencesResponse$ = [3, n0, _GRPRe,
    0,
    [_nT, _rPD],
    [0, () => RecommendationPreferencesDetails]
];
export var GetRecommendationSummariesRequest$ = [3, n0, _GRSR,
    0,
    [_aIc, _nT, _mR],
    [64 | 0, 0, 1]
];
export var GetRecommendationSummariesResponse$ = [3, n0, _GRSRe,
    0,
    [_nT, _rS],
    [0, () => RecommendationSummaries]
];
export var Gpu$ = [3, n0, _G,
    0,
    [_gC, _gMSIMB],
    [1, 1]
];
export var GpuInfo$ = [3, n0, _GI,
    0,
    [_g],
    [() => Gpus]
];
export var IdleEstimatedMonthlySavings$ = [3, n0, _IEMS,
    0,
    [_cu, _v],
    [0, 1]
];
export var IdleRecommendation$ = [3, n0, _IR,
    0,
...
export var IdleRecommendationError$ = [3, n0, _IRE,
    0,
    [_id, _cod, _m, _rT],
    [0, 0, 0, 0]
];
export var IdleRecommendationFilter$ = [3, n0, _IRF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
export var IdleSavingsOpportunity$ = [3, n0, _ISO,
    0,
    [_sOP, _eMS],
    [1, () => IdleEstimatedMonthlySavings$]
];
export var IdleSavingsOpportunityAfterDiscounts$ = [3, n0, _ISOAD,
    0,
    [_sOP, _eMS],
    [1, () => IdleEstimatedMonthlySavings$]
];
export var IdleSummary$ = [3, n0, _IS,
    0,
    [_n, _v],
    [0, 1]
];
...
export var InstanceEstimatedMonthlySavings$ = [3, n0, _IEMSn,
    0,
    [_cu, _v],
    [0, 1]
];
export var InstanceRecommendation$ = [3, n0, _IRn,
    0,
...
export var InstanceRecommendationOption$ = [3, n0, _IRO,
    0,
...
export var InstanceSavingsEstimationMode$ = [3, n0, _ISEM,
    0,
    [_so],
    [0]
];
export var InstanceSavingsOpportunityAfterDiscounts$ = [3, n0, _ISOADn,
    0,
    [_sOP, _eMS],
...
export var LambdaEffectiveRecommendationPreferences$ = [3, n0, _LERP,
    0,
    [_sEM],
    [() => LambdaSavingsEstimationMode$]
];
export var LambdaEstimatedMonthlySavings$ = [3, n0, _LEMS,
    0,
    [_cu, _v],
    [0, 1]
];
...
export var LambdaFunctionRecommendation$ = [3, n0, _LFR,
    0,
...
export var LambdaFunctionRecommendationFilter$ = [3, n0, _LFRF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
...
export var LambdaSavingsOpportunityAfterDiscounts$ = [3, n0, _LSOAD,
    0,
    [_sOP, _eMS],
    [1, () => LambdaEstimatedMonthlySavings$]
];
export var LicenseConfiguration$ = [3, n0, _LC,
    0,
    [_nOC, _iT, _oS, _lE, _lN, _lM, _lV, _mSet],
    [1, 0, 0, 0, 0, 0, 0, () => MetricsSource]
];
export var LicenseRecommendation$ = [3, n0, _LR,
    0,
    [_rA, _aI, _cLC, _lPID, _lRT, _f, _fRC, _lRO, _ta],
    [0, 0, () => LicenseConfiguration$, 1, 4, 0, 64 | 0, () => LicenseRecommendationOptions, () => Tags]
];
export var LicenseRecommendationFilter$ = [3, n0, _LRF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
export var LicenseRecommendationOption$ = [3, n0, _LRO,
    0,
    [_r, _oS, _lE, _lM, _sO],
...
export var PreferredResource$ = [3, n0, _PR,
    0,
    [_n, _iL, _eL],
    [0, 64 | 0, 64 | 0]
];
export var ProjectedMetric$ = [3, n0, _PM,
    0,
    [_n, _ti, _va],
    [0, 64 | 4, 64 | 1]
];
export var PutRecommendationPreferencesRequest$ = [3, n0, _PRPR,
    0,
...
export var PutRecommendationPreferencesResponse$ = [3, n0, _PRPRu,
    0,
    [],
    []
];
export var RDSDatabaseProjectedMetric$ = [3, n0, _RDSDPM,
    0,
    [_n, _ti, _va],
    [0, 64 | 4, 64 | 1]
];
export var RDSDatabaseRecommendedOptionProjectedMetric$ = [3, n0, _RDSDROPM,
    0,
    [_rDBIC, _r, _pM],
    [0, 1, () => RDSDatabaseProjectedMetrics]
];
export var RDSDBInstanceRecommendationOption$ = [3, n0, _RDSDBIRO,
    0,
...
export var RDSDBRecommendation$ = [3, n0, _RDSDBR,
    0,
...
export var RDSDBRecommendationFilter$ = [3, n0, _RDSDBRF,
    0,
    [_n, _va],
    [0, 64 | 0]
];
export var RDSDBStorageRecommendationOption$ = [3, n0, _RDSDBSRO,
    0,
...
export var RDSInstanceEstimatedMonthlySavings$ = [3, n0, _RDSIEMS,
    0,
    [_cu, _v],
    [0, 1]
];
export var RDSInstanceSavingsOpportunityAfterDiscounts$ = [3, n0, _RDSISOAD,
    0,
    [_sOP, _eMS],
    [1, () => RDSInstanceEstimatedMonthlySavings$]
];
export var RDSSavingsEstimationMode$ = [3, n0, _RDSSEM,
    0,
    [_so],
    [0]
];
export var RDSStorageEstimatedMonthlySavings$ = [3, n0, _RDSSEMS,
    0,
    [_cu, _v],
    [0, 1]
];
export var RDSStorageSavingsOpportunityAfterDiscounts$ = [3, n0, _RDSSSOAD,
    0,
    [_sOP, _eMS],
    [1, () => RDSStorageEstimatedMonthlySavings$]
];
export var ReasonCodeSummary$ = [3, n0, _RCS,
    0,
    [_n, _v],
    [0, 1]
];
...
export var RecommendationPreferencesDetail$ = [3, n0, _RPD,
    0,
...
export var RecommendationSource$ = [3, n0, _RS,
    0,
    [_rSA, _rST],
    [0, 0]
];
...
export var RecommendedOptionProjectedMetric$ = [3, n0, _ROPM,
    0,
    [_rIT, _r, _pM],
...
export var SavingsOpportunity$ = [3, n0, _SO,
    0,
    [_sOP, _eMS],
...
export var ServiceConfiguration$ = [3, n0, _SC,
    0,
...
export var VolumeConfiguration$ = [3, n0, _VC,
    0,
    [_vT, _vS, _vBIOPS, _vBIOPSo, _vBT, _vBTo, _rV],
    [0, 1, 1, 1, 1, 1, 2]
];
export var VolumeRecommendation$ = [3, n0, _VR,
    0,
...
export var VolumeRecommendationOption$ = [3, n0, _VRO,
    0,
